...
TEST_F(ExprParserBooleanLedTest, ConstantAndConstant) {
    BooleanConstantTestCase test_cases[] = {
        ...
        {     "0 and 3",PRATT_EXPR_TYPE_CONSTANT,      semiValueIntCreate(0),"0 and 3 should return 0 (lhs is falsy)"                                                                              },
        {     "3 and 0",
         PRATT_EXPR_TYPE_CONSTANT,      semiValueIntCreate(0),
         "3 and 0 should return 0 (lhs is truthy, return rhs)"                                                             },
        {     "3 and 5",
         PRATT_EXPR_TYPE_CONSTANT,      semiValueIntCreate(5),
         "3 and 5 should return 5 (lhs is truthy, return rhs)"                                                             },
        { "0 and false", PRATT_EXPR_TYPE_CONSTANT,      semiValueIntCreate(0), "0 and false should return 0 (lhs is falsy)"},
        {  "true and 7",
         PRATT_EXPR_TYPE_CONSTANT,      semiValueIntCreate(7),
         "true and 7 should return 7 (lhs is truthy, return rhs)"                                                          },
        {"false and 42",
         PRATT_EXPR_TYPE_CONSTANT, semiValueBoolCreate(false),
         "false and 42 should return false (lhs is falsy)"                                                                 },

        // OR operations: returns lhs if lhs is truthy, returns rhs if lhs is falsy
        {      "0 or 3",
         PRATT_EXPR_TYPE_CONSTANT,      semiValueIntCreate(3),
         "0 or 3 should return 3 (lhs is falsy, return rhs)"                                                               },
        {      "3 or 0", PRATT_EXPR_TYPE_CONSTANT,      semiValueIntCreate(3),     "3 or 0 should return 3 (lhs is truthy)"},
        {  "0 or false",
         PRATT_EXPR_TYPE_CONSTANT, semiValueBoolCreate(false),
        ...
        {  "true or 42",
         PRATT_EXPR_TYPE_CONSTANT,  semiValueBoolCreate(true),
         "true or 42 should return true (lhs is truthy)"                                                                   },
        {     "5 or 10", PRATT_EXPR_TYPE_CONSTANT,      semiValueIntCreate(5),    "5 or 10 should return 5 (lhs is truthy)"},
    };
